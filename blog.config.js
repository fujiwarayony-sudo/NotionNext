...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jaa', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Art Director', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jaaa.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Jaa', // 网站关键词 英文逗号隔开
